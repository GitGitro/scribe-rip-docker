# Docker images for Scribe

ghcr.io images for Scribe, the alternative Medium Frontend
Changes from the main [repo](https://git.sr.ht/~edwardloveall/scribe) are synced manually, so feel free to open an issue if it hasn't been updated
